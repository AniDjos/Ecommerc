...
$totalProductsQuery = "SELECT COUNT(category_id) AS total_products FROM categories ";
...
$productQuery = "SELECT * FROM categories LIMIT $productsPerPage OFFSET $offset";
$productResult = $bdd->query($productQuery);
$categorie = $productResult->fetchAll(PDO::FETCH_ASSOC);
